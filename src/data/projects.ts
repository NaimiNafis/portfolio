...
export const projects: Project[] = [
  ...
  },
  {
    ...
    tag: 'Demo',
    href: 'https://kamocomo.vercel.app',
    repo: 'https://github.com/NaimiNafis/kamocomo',
    description:
    ...
    meta: 'Lead engineer, team of 6 · 2026',
    color: '#34688C',
  },
  {
    slug: 'lyrika',
    title: 'Lyrika',
    tag: '3rd / 24',
    href: 'https://github.com/NaimiNafis/Lyrika',
    description:
  ...
  },
  {
    ...
    title: 'Readoku',
    tag: 'Hackathon',
    href: 'https://github.com/NaimiNafis/readoku',
    description:
